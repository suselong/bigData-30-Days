...
- [Day09MapReduce案例](Day09MapReduce优化案例/README.md)
    ...
    - [x] [案例3：小文件合并(通过自定义InputFormat实现)](Day09MapReduce优化案例/README.md#小文件合并(通过自定义InputFormat实现))   
    - [ ] [案例4：OutPutFormat自定义](Day09MapReduce优化案例/README.md)
    - [ ] [案例5：数据压缩优化](Day09MapReduce优化案例/README.md)
    - [ ] [案例6：MapJoin自定义](Day09MapReduce优化案例/README.md)
    - [ ] [案例7：ReduceJoin自定义](Day09MapReduce优化案例/README.md)
