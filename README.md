...
- [MapReduce核心编程思想](Day06MapReduce/README.md#MapReduce核心编程思想)
- [MapReduce案例](Day06MapReduce/README.md#MapReduce案例)
- [MapReduce集群模式运行](Day06MapReduce/README.md#MapReduce集群模式运行)
- [Yarn任务提交流程](Day06MapReduce/README.md#Yarn任务提交流程)
- [Hadoop数据类型](Day06MapReduce/README.md#Hadoop数据类型)
- [序列化与反序列化](Day06MapReduce/README.md#Hadoop数据类型)
- [Hadoop中的序列化](Day06MapReduce/README.md#Hadoop数据类型)
- [手机流量统计案例](Day06MapReduce/README.md#手机流量统计案例)
